#!/usr/bin/env python3
"""
Google Reviews Scraper - Scrape Google Maps reviews - ratings, text, author, dates
Open source scraper for google reviews scraper, scrape google reviews, google maps reviews scraper
...
class GoogleReviewsScraperScraper:
    """Scraper for Google Reviews Scraper."""
...
def main():
    parser = argparse.ArgumentParser(description="Google Reviews Scraper - Scrape Google Maps reviews - ratings, text, author, dates")
    ...
    scraper = GoogleReviewsScraperScraper(proxy=args.proxy)
